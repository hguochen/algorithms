...
class BinarySearchTree(object):
    ...
    def search(self, data):
        ...
        Search for data node in tree and return the node. Otherwise return
        None.
    ...
    def _parent_child_set(self, data):
        ...
        Return node with data and its parent node.
    ...
    def successor(self, data):
        ...
        Given *data* in tree, find the next value by inorder traversal method.
    ...
    def predecessor(self, data):
        ...
        Given *data* in tree, find the previous value by inorder traversal
        method.
